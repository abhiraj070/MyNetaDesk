 ...
 * The X section.
 *
 * Live X integration is still being built, so the sheet currently carries a
 * preview of what is coming rather than a feed (see `XPulsePreview`). It keeps
 * its own props and its place in the bottom bar, so restoring the live feed
 * later is a matter of putting the list back inside this shell — `TweetCard`,
 * `TweetSkeleton` and the `useTweets` hook are all untouched and waiting, and
 * the feed version of this file is preserved verbatim at the bottom.
 *
